...
void PlotRnPoRowVsTime(){

	setup_PROSPECT_style();
    gROOT->ForceStyle();

	TGraphErrors *grRate[NUMROWS],	 	   *grRelRate[NUMROWS];
	TGraphErrors *grPoPSDMean[NUMROWS],    *grRelPoPSDMean[NUMROWS];
	TGraphErrors *grPoPSDSigma[NUMROWS],   *grRelPoPSDSigma[NUMROWS];
	TGraphErrors *grPoEnMean[NUMROWS],     *grRelPoEnMean[NUMROWS];
	TGraphErrors *grPoEnSigma[NUMROWS],    *grRelPoEnSigma[NUMROWS];
	TGraphErrors *grPoPosSigma[NUMROWS],   *grRelPoPosSigma[NUMROWS];
	TGraphErrors *grRnPoDzSigma[NUMROWS],  *grRelRnPoDzSigma[NUMROWS];
	

	TFile *f = new TFile(Form("%s/Ac227_RowGraphsPerTime.root",gSystem->Getenv("AD_AC227ANALYSIS_RESULTS")));
	...
	//-------------------------------------------------------------------------------------------------------
	int col[NUMROWS] = {36,30,28,11,9,8,7,6,4,2,1};
	...
	leg->Draw();
	cRelRate->SaveAs(Form("%s/RowRelativeRateVsTime.pdf",gSystem->Getenv("AD_AC227_PLOTS")));
	cRelRate->SaveAs(Form("%s/RowRelativeRateVsTime.png",gSystem->Getenv("AD_AC227_PLOTS")));
	...
	leg->Draw();
	cRelPoPSDMean->SaveAs(Form("%s/RowRelativePoPSDMeanVsTime.pdf",gSystem->Getenv("AD_AC227_PLOTS")));
	cRelPoPSDMean->SaveAs(Form("%s/RowRelativePoPSDMeanVsTime.png",gSystem->Getenv("AD_AC227_PLOTS")));
	...
	leg->Draw();
	cRelPoPSDSigma->SaveAs(Form("%s/RowRelativePoPSDSigmaVsTime.pdf",gSystem->Getenv("AD_AC227_PLOTS")));
	cRelPoPSDSigma->SaveAs(Form("%s/RowRelativePoPSDSigmaVsTime.png",gSystem->Getenv("AD_AC227_PLOTS")));
	...
	leg->Draw();
	cRelPoEnMean->SaveAs(Form("%s/RowRelativePoEnMeanVsTime.pdf",gSystem->Getenv("AD_AC227_PLOTS")));
	cRelPoEnMean->SaveAs(Form("%s/RowRelativePoEnMeanVsTime.png",gSystem->Getenv("AD_AC227_PLOTS")));
	...
	leg->Draw();
	cRelPoEnSigma->SaveAs(Form("%s/RowRelativePoEnSigmaVsTime.pdf",gSystem->Getenv("AD_AC227_PLOTS")));
	cRelPoEnSigma->SaveAs(Form("%s/RowRelativePoEnSigmaVsTime.png",gSystem->Getenv("AD_AC227_PLOTS")));
	...
	leg->Draw();
	cRelPoPosSigma->SaveAs(Form("%s/RowRelativePoPosSigmaVsTime.pdf",gSystem->Getenv("AD_AC227_PLOTS")));
	cRelPoPosSigma->SaveAs(Form("%s/RowRelativePoPosSigmaVsTime.png",gSystem->Getenv("AD_AC227_PLOTS")));
	...
	leg->Draw();
	cRelRnPoDzSigma->SaveAs(Form("%s/RowRelativeRnPoDzSigmaVsTime.pdf",gSystem->Getenv("AD_AC227_PLOTS")));
	cRelRnPoDzSigma->SaveAs(Form("%s/RowRelativeRnPoDzSigmaVsTime.png",gSystem->Getenv("AD_AC227_PLOTS")));
