...
void setup_PROSPECT_style(TStyle* prospectStyle) {
    ...
    prospectStyle->SetPadTopMargin(.08); // just enough to clear exponent on y axis
    //prospectStyle->SetPadLeftMargin(.151);
    //prospectStyle->SetPadLeftMargin(.085);
    prospectStyle->SetPadLeftMargin(.1);
    ...
    prospectStyle->SetTitleOffset(0.8,"y");
